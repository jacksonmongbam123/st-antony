...
export function Navbar() {
  ...
  >
    ...
    onClick={() => alert("\u{1F510} Login portal launching soon!\nContact: admissions@stantonys.edu.in")}
    style={{
  ...
  >
    ...
    style={{
      ...
      borderRadius: 2,
      transition: "all .3s",
      transform: mobileOpen ? i === 0 ? "rotate(45deg) translate(5px,5px)" : i === 1 ? "scaleX(0)" : "rotate(-45deg) translate(5px,-5px)" : "none",
  ...
  >
    ...
    /* Login button */
          ...
          <div style={{ padding: "16px 20px" }}>
            <button
    onClick={() => {
      alert("\u{1F510} Login portal launching soon!\nContact: admissions@stantonys.edu.in");
      setMobileOpen(false);
    }}
    className="neu-btn"
    style={{
...
export function Hero() {
  ...
  useEffect(() => {
    timerRef.current = setInterval(() => goTo(cur + 1), 5e3);
...
export function VisionMission() {
  ...
  >
        {CARDS.map((c, i) => <VisionCard key={i} card={c} index={i} />)}
      </div>
    </section>;
}
export function AcademicPerformance() {
  const [category, setCategory] = useState("puc");
  ...
  />
    ...
    boxShadow: "4px 4px 10px rgba(201,150,58,0.3), inset 2px 2px 5px rgba(255,255,255,0.4)"
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "clamp(12px, 4vw, 20px)", marginBottom: 24, width: "100%", flexWrap: "wrap" }}>
              ...
              <div style={{ width: 1, background: "rgba(0,0,0,0.1)", display: "block" }} />
              <div style={{ textAlign: "center" }}>
  ...
  ].map((row, idx) => <tr key={idx} style={{ borderBottom: "1px solid rgba(15,32,68,0.03)" }}>
                      <td style={{ padding: "16px 8px", fontWeight: 600, color: T.navy }}>
                        <span style={{ display: "inline-block", width: 8, height: 8, borderRadius: "50%", background: row.color, marginRight: 12 }} />
                        {row.label}
                      </td>
...
export function Achievements() {
  ...
  useEffect(() => {
    timerRef.current = setInterval(() => goSlide(activeSlide + 1), 8e3);
    return () => clearInterval(timerRef.current);
  }, [activeSlide, goSlide]);
  const slide = cat.slides[activeSlide];
  return <section id="achievements" style={{ background: T.navy, padding: isDesktop ? "80px 7%" : "60px 4%", position: "relative", overflow: "hidden" }}>
      {
  ...
  />
    ...
    /* Category tabs */
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 40, flexWrap: "wrap", position: "relative", zIndex: 2 }}>
        {ACHIEVEMENT_DATA.map((c, i) => <button
    key={i}
    onClick={() => {
      setActiveTab(i);
      clearInterval(timerRef.current);
  ...
  >
            {slide.images && slide.images.length > 0 ? <div style={{ position: "absolute", inset: 0 }}>
                <img
  ...
  />
              </div> : <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, rgba(0,0,0,.2), rgba(0,0,0,.05))" }} />}
  ...
  >
    ...
    /* Inner dots for Image Gallery */
            ...
            {slide.images && slide.images.length > 1 && <div
    style={{
      position: "absolute",
      bottom: 16,
      left: "50%",
...
export function Faculty() {
  const [mainCat, setMainCat] = useState("highSchool");
  ...
  >
    ...
    /* Sub-Category Selector */
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: 12, marginBottom: 32, flexWrap: "wrap" }}>
        {mainCat === "highSchool" ? ["8th Standard", "9th Standard", "10th Standard"].map((std) => <button
    key={std}
  ...
  >
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {["1st PUC", "2nd PUC"].map((puc) => <button
    key={puc}
...
export function ContactUs() {
  ...
  >
          ...
          {[
    { icon: "\u{1F4CD}", label: "Address", val: "St. Antony's Catholic Church Mugatageri,\nPonnampet \u2014 571216, Karnataka" },
    { icon: "\u{1F4DE}", label: "Phone", val: "+91 9448315531" },
    { icon: "\u2709\uFE0F", label: "Email", val: "info@stantonys.edu.in" },
    { icon: "\u{1F550}", label: "Office Hours", val: "Mon \u2013 Sat: 8:00 AM \u2013 5:00 PM" }
  ].map(({ icon, label, val }) => <div key={label} style={{ display: "flex", gap: 16, alignItems: "center", minHeight: 60 }}>
              <div
    style={{
      width: 42,
      height: 42,
  ...
  >
    ...
    /* Social icons */
          ...
          <div style={{ display: "flex", gap: 10, marginTop: "auto" }}>
            {["\u{1F4D8}", "\u{1F4F7}", "\u25B6\uFE0F"].map((ic, i) => <div
    key={i}
    style={{
      width: 34,
      height: 34,
  ...
  >
                ...
                {["Admissions", "Fee Structure", "Scholarships", "Faculty", "Facilities", "General"].map((o) => <option key={o}>{o}</option>)}
              </select>
            </div>
            <div>
  ...
  >
    ...
    /* Social Links */
          ...
          <div style={{ display: "flex", gap: 12 }}>
            {[
    { icon: "\u{1F4D8}", label: "Facebook" },
    { icon: "\u{1F4F7}", label: "Instagram" },
    ...
    /* 2. Quick Links */
        ...
        <div style={{ textAlign: "left" }}>
          <h4 style={footerHeadingStyle}>
            Quick Links
            <div style={{ position: "absolute", bottom: 0, left: 0, width: 30, height: 2, background: T.gold }} />
          </h4>
          <ul style={{ listStyle: "none" }}>
            {["Home", "About Us", "Admissions", "Achievements", "Contact Us"].map((item) => <li key={item}>
                <a
  ...
  >
    ...
    /* 3. Academic Links */
        ...
        <div style={{ textAlign: "left" }}>
          ...
          <ul style={{ listStyle: "none" }}>
            {["Science Stream", "Commerce Stream", "Arts Stream", "Curriculum", "Faculty"].map((item) => <li key={item}>
                <a
    href="#"
    style={footerLinkStyle}
    onMouseEnter={(e) => {
    ...
    /* 4. Contact Information */
        ...
        <div style={{ textAlign: "left" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            {[
    { icon: "\u{1F4CD}", text: "St. Antony's Catholic Church Mugatageri, Ponnampet \u2014 571216, Karnataka" },
    { icon: "\u{1F4DE}", text: "+91 9448315531" },
    { icon: "\u2709\uFE0F", text: "info@stantonys.edu.in" },
    { icon: "\u{1F550}", text: "Mon \u2013 Sat: 8:00 AM \u2013 5:00 PM" }
  ].map((item, i) => <div key={i} style={footerContactItemStyle}>
